...
VBS_samples = ["aQGC_WMLEPWMHADjj_EWK"] # "VBS_ssWW", "VBS_WZjj", "VBS_WZll", "VBS_ZZ"]
...
for operator in shortoperatorsdata:
    ...
    for opweight in shortoperatorsdata[operator]:
        ...
        VBS_samples.append("aQGC_WMLEPWMHADjj_EWK_"+variation)
        aliases[variation+"_w"] = {
        'expr': variation+"/LHEWeight_originalXWGTUP"
        }
...
#     'linesToAdd':[
#         'gSystem->Load("libLatinoAnalysisMultiDraw.so")',
#         '.L {}/VBSjjlnu/macros/VBS_jets_selection_ireneUL.cc+'.format(configurations)
#     ],
# }
