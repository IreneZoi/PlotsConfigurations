...
variables['eta0_vbs_Gen'] ={  'name' : 'eta0_vbs_Gen',
                            'range' : (20,-5,5),
                            'xaxis' : '#eta_{1}^{VBS}', 
                            'fold' : 0,
                            } 
variables['eta1_vbs_Gen'] ={  'name' : 'eta1_vbs_Gen',
                            'range' : (20,-5,5),
                            'xaxis' : '#eta_{2}^{VBS}', 
                            'fold' : 0,
                            }

variables['pt0_vbs_Gen'] = {   'name': 'pt0_vbs_Gen',      
                        'range' : (35,50,400),  
                        'xaxis' : 'p_{T,1}^{VBS}', 
                        'fold' : 3
                        } 

variables['pt1_vbs_Gen'] = {   'name': 'pt1_vbs_Gen',      
                        'range' : (35,50,400),  
                        'xaxis' : 'p_{T,0}^{VBS}', 
                        'fold' : 3
                        } 

variables['mjj_vbs_Gen'] = {   'name': 'mjj_vbs_Gen',      
                        'range' : (25,500,3500) , 
                        'xaxis' : 'M_{jj} VBS', 
                        'fold' : 3,
...
# variables['GenVBFeta1_fm7_80p00_bis'] ={  'name' : 'GenJet_eta[0]*fm7_80p00/LHEWeight_originalXWGTUP',
#                             'range' : (20,-5,5),
#                             'xaxis' : '#eta_{1}^{VBF}', 
#                             'fold' : 0,
#                             }

# variables['GenVBFeta1_fs2_30p00_bis'] ={  'name' : 'GenJet_eta[0]*fs2_30p00/LHEWeight_originalXWGTUP',
#                             'range' : (20,-5,5),
#                             'xaxis' : '#eta_{1}^{VBF}', 
#                             'fold' : 0,
#                             }
# ########################
# variables['GenVBFeta2_fs2_30p00_bis'] ={  'name' : 'GenJet_eta[1]*fs2_30p00/LHEWeight_originalXWGTUP',
#                             'range' : (20,-5,5),
#                             'xaxis' : '#eta_{2}^{VBF}', 
#                             'fold' : 0,
#                             }
...
#         #var='GenJet_eta[0]*'+variation+'/LHEWeight_originalXWGTUP'
#         variables['GenVBFeta1_'+variation]= {  
#                             #'name' : 'GenJet_eta[0]*'+variation+'/LHEWeight_originalXWGTUP',
#                             # 'name' : 'GenJet_eta[0]*'+variation+'_w',
#                             'name' : 'GenJet_eta[0]*'+str(desperate),
#                             'range' : (20,-5,5),
#                             'xaxis' : '#eta_{1}^{VBF}', 
#                             'fold' : 0,
#                             }
