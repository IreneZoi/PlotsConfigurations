...
#   e.g.: python2 EFTcoefficients/delete_statistical_uncertainty.py -i=/eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/rootFile_fit_v4.5_2017_split_aQGC_Aug2024_cT0_again/plots_fit_v4.5_2017_split_aQGC_Aug2024_cT0_again_withBKG.root -vars=Mww_binzv+events+fit_bin_boost
