...
#     -o output_histograms_${YEAR}_EFT_WV_${operator}_${CUT}.root \
#     --postfit --sampling \
...
mkdir -p /eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/postfit/WV_${YEAR}/${operator}/
mkdir -p /eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/postfit/WV_${YEAR}/${operator}/${Category}/
mkdir -p /eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/postfit/WV_${YEAR}/${operator}/${Category}/${CUT}/
mkdir -p /eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/postfit/WV_${YEAR}/${operator}/${Category}/${CUT}/${PLOTVAR}
mkdir -p /eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/prefit/WV_${YEAR}/${operator}/
mkdir -p /eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/prefit/WV_${YEAR}/${operator}/${Category}/
mkdir -p /eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/prefit/WV_${YEAR}/${operator}/${Category}/${CUT}/
mkdir -p /eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/prefit/WV_${YEAR}/${operator}/${Category}/${CUT}/${PLOTVAR}

# # clean local folder
rm -r plot_combined/*

mkPostFitCombinedPlot.py \
  --inputFilePostFitShapesFromWorkspace output_histograms_${YEAR}_EFT_WV_${operator}_${CUT}.root \
  --outputFile output_postfit_${YEAR}_EFT_WV_${operator}_${CUT}.root \
  --kind P \
  --cutName ${CUT} \
  --variable ${PLOTVAR} \
...
mkPlot.py --pycfg=configuration_combined.py --inputFile=output_postfit_${YEAR}_EFT_WV_${operator}_${CUT}.root --onlyPlot=cratio --logOnly --showIntegralLegend=1 --minLogCratio=0.1 --maxLogCratio=10000

cp -r plot_combined/*png /eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/postfit/WV_${YEAR}/${operator}/${Category}/${CUT}/${PLOTVAR}/
...
mkPostFitCombinedPlot.py \
  --inputFilePostFitShapesFromWorkspace output_histograms_${YEAR}_EFT_WV_${operator}_${CUT}.root \
  --outputFile output_prefit_${YEAR}_EFT_WV_${operator}_${CUT}.root \
  --kind p \
  --cutName ${CUT} \
  --variable ${PLOTVAR} \
  --structureFile ../Full${YEAR}v7/conf_fit_v4.5_aQGC/structure_split.py \
...
mkPlot.py --pycfg=configuration_combined.py --inputFile=output_prefit_${YEAR}_EFT_WV_${operator}_${CUT}.root --onlyPlot=cratio --logOnly --showIntegralLegend=1 --minLogCratio=0.1 --maxLogCratio=10000

cp -r plot_combined/*png /eos/user/i/izoi/VBS_SM_WV_semilep_aQGC/prefit/WV_${YEAR}/${operator}/${Category}/${CUT}/${PLOTVAR}/
