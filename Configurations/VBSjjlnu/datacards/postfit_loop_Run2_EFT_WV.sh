...
DatacardPATHpartial=/afs/cern.ch/work/i/izoi/VBSanalysis/CMSSW_11_1_4/src/PlotsConfigurations/Configurations/VBSjjlnu/Full2018v7/datacards_fit_v4.5_2018_split_aQGC_cT0_NoVBS/${CUT}/${PLOTVAR}/
...
##############################################
#
# ->->->->->->->    step - 2b: as the description below says: get post fit shapes from workspace (done in analysis setup)
