...
categories=(boost_wjetcr_ele) # boost_wjetcr_mu res_wjetcr_ele res_wjetcr_mu boost_topcr_ele boost_topcr_ele res_topcr_ele res_topcr_mu res_sig_ele res_sig_mu boost_sig_ele boost_sig_mu )
variables=(mjj_vbs)  #  (fit_bins_boost    fit_bins_boost  fit_bins_res  fit_bins_res events events events events DNNoutput_res_v1 DNNoutput_res_v1 DNNoutput_boost DNNoutput_boost)
