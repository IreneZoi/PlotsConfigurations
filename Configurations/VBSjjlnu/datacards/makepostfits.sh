...
years=(Run2)
# years=(2018)
categories_boost=(boost_sig_ele boost_sig_mu boost_wjetcr_mu  boost_wjetcr_ele  )
# categories_boost=( boost_wjetcr_mu boost_wjetcr_ele boost_sig_mu boost_sig_ele)
# categories_boost=(boost_wjetcr_ele boost_wjetcr_mu
#         boost_sig_ele_DNN_geq_0p5 boost_sig_mu_DNN_geq_0p5 
#         boost_sig_ele_DNN_leq_0p5 boost_sig_mu_DNN_leq_0p5
# )
# categories_boost=(boost_topcr_mu boost_sig_ele boost_sig_mu)
variables_boost=( Mww_binzv )
#fit_bins_boost   deltaeta_vbs mjj_vbs )
...
# variables_boost=(Mww_rebinned_SplitLastTwo)
...
outdir=Postfit_${operator}_Aug2024_${region}_SRvar${fitvar}/
mkdir ${outdir}
cd 
...
for year in ${years[*]}; do
    echo " plotting ${year}"
    source postfit_loop_Run2_EFT_WV_env.sh ${region} boost_sig_ele events ${year} ${fitvar} true ${operator}
    ...
    #         # datacardDir2=Full${year}v7/datacards_fit_v4.5_${year}_split_aQGC_${operator}_eboliv2_official_testDY # eboliv2
