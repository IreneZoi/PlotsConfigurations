...
mc =["DY", "top", "VV", "VVV", "VBF-V", "VBF-V_dipole", "Vg", "VgS", "VBS", "ggWW"] + wjets_all_bins + VBS_samples + VV_samples + VBS_aQGC_samples
...
nuisances['pdf_weight'] = {
    ...
    # 'samples' :  { s: [' Alt$(LHEPdfWeight['+str(i)+'], 1.)' for i in range(0,32)] for s in VBS_aQGC_samples}, # eboliv2 attempt from Irene
    'AsLnN':  '1'
}
...
#nuisance_redoing = ["stat","btag","trig","eff_e","electronpt","eff_m","muonpt","JetPUID_sf","JER","MET","tagging","fatjetJM","QCD_scale_signal"] + jes_systs
# for n in nuisance_redoing:
#     nuisances = {k:v for k,v in nuisances.items() if n in k}
# for n in nuisance_redoing:
