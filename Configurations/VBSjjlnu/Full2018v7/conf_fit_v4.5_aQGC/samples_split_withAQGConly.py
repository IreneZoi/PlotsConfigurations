...
for operator, expressions in operators.items():
    ...
    addSampleWeight(samples, 'quad_'+operator, 'WpToLNu_WmTo2J_aQGC_eboliv2_official', smLinQuadReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WpTo2J_WmToLNu_aQGC_eboliv2_official', smLinQuadReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WpToLNu_WpTo2J_aQGC_eboliv2_official', smLinQuadReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WmToLNu_WmTo2J_aQGC_eboliv2_official', smLinQuadReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WmToLNu_ZTo2J_aQGC_eboliv2_official', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smLinQuadReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WpToLNu_ZTo2J_aQGC_eboliv2_official', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smLinQuadReweight)
    ...
    addSampleWeight(samples, 'quad_'+operator, 'WpToLNu_WmTo2J_aQGC_eboliv2_official', smReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WpTo2J_WmToLNu_aQGC_eboliv2_official', smReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WpToLNu_WpTo2J_aQGC_eboliv2_official', smReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WmToLNu_WmTo2J_aQGC_eboliv2_official', smReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WmToLNu_ZTo2J_aQGC_eboliv2_official', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WpToLNu_ZTo2J_aQGC_eboliv2_official', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smReweight)
