...
groupPlot['sm_lin_quad_OPERATOR']  = {
                'nameHR' : 'SM+Linear+Quadratic OPERATOR',
                'isSignal' : 1,
                'color': colors["kRed"],
                'samples'  : ['sm_lin_quad_OPERATOR'],
                'fill': 1001
             }

groupPlot['quad_OPERATOR']  = {
                 'nameHR' : 'Quadratic OPERATOR',
                 'isSignal' : 1,
                 'color': colors["kRed"]+2,
                 'samples'  : ['quad_OPERATOR'],
                 'fill': 1001
              }
