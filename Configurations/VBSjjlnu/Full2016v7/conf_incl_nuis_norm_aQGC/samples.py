...
samples['quad_cT0']  = { 'name' :  
                nanoGetSampleFiles(directory_signal,'WpToLNu_WmTo2J_aQGC') + #VBS_osWW
                nanoGetSampleFiles(directory_signal,'WpTo2J_WmToLNu_aQGC') + #VBS_osWW
                nanoGetSampleFiles(directory_signal,'WpToLNu_WpTo2J_aQGC') + #VBS_ssWW
                nanoGetSampleFiles(directory_signal,'WmToLNu_WmTo2J_aQGC') + #VBS_ssWW
                nanoGetSampleFiles(directory_signal,'WmToLNu_ZTo2J_aQGC'),   #VBS_WZjj
#                nanoGetSampleFiles(directory_signal,'WpToLNu_ZTo2J_aQGC'),   #VBS_WZjj
...
samples['sm_lin_quad_cT0'] = {
   'name':   nanoGetSampleFiles(directory_signal,'WpToLNu_WmTo2J_aQGC') #VBS_osWW
            +nanoGetSampleFiles(directory_signal,'WpTo2J_WmToLNu_aQGC') #VBS_osWW
            +nanoGetSampleFiles(directory_signal,'WpToLNu_WmTo2J')      #VBS_osWW
            +nanoGetSampleFiles(directory_signal,'WpTo2J_WmToLNu')      #VBS_osWW
            +nanoGetSampleFiles(directory_signal,'WpToLNu_WpTo2J_aQGC') #VBS_ssWW
            +nanoGetSampleFiles(directory_signal,'WmToLNu_WmTo2J_aQGC') #VBS_ssWW
            +nanoGetSampleFiles(directory_signal,'WpToLNu_WpTo2J')      #VBS_ssWW
