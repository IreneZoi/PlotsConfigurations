...
samples['sm'] = {
    ...
    'weight': XSWeight+'*'+SFweight+'*'+METFilter_MC+'*'+GenLepMatch +'*'+smReweight,
    # 'EventsPerJob': 100000,
    'FilesPerJob': 2
}
...
for operator, expressions in operators.items():
    ...
    samples['quad_'+operator] = { 'name':  
        ...
        'weight':  XSWeight+'*'+SFweight+'*'+METFilter_MC+'*'+GenLepMatch + '*'+ quadReweight,
        'FilesPerJob': 2
    }
    ...
    smLinQuadReweight = '('+smReweight + '+' + linReweight + '+' + quadReweight + ')'
    samples['sm_lin_quad_'+operator] = { 'name':
            ...
            +nanoGetSampleFiles(directory_signalIZ, 'WmToLNu_ZTo2J_aQGC_Aug2024')  #VBS_WZjj
            +nanoGetSampleFiles(directory_signalIZ, 'WpToLNu_ZTo2J_aQGC_Aug2024'),  #VBS_WZjj
        'weight':  XSWeight+'*'+SFweight+'*'+METFilter_MC+'*'+GenLepMatch +'*'+smLinQuadReweight,
        'FilesPerJob': 2
    }
    ...
    #     'FilesPerJob': 10
    # }
    # addSampleWeight(samples, 'sm_WpToLNu_WmTo2J_'+operator, 'WpToLNu_WmTo2J_aQGC_Aug2024', smReweight)
    ...
    #     'FilesPerJob': 10
    # }
    # addSampleWeight(samples, 'sm_WpTo2J_WmToLNu_'+operator, 'WpTo2J_WmToLNu_aQGC_Aug2024', smReweight)
    ...
    #     'FilesPerJob': 10
    # }
    # addSampleWeight(samples, 'sm_WpToLNu_WpTo2J_'+operator, 'WpToLNu_WpTo2J_aQGC_Aug2024', smReweight)
    ...
    #     'FilesPerJob': 10
    # }
    # addSampleWeight(samples, 'sm_WmToLNu_WmTo2J_'+operator, 'WmToLNu_WmTo2J_aQGC_Aug2024', smReweight)
    ...
    #     'FilesPerJob': 10
    # }
    # addSampleWeight(samples, 'sm_WmToLNu_ZTo2J_'+operator, 'WmToLNu_ZTo2J_aQGC_Aug2024', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smReweight)
    ...
    #     'FilesPerJob': 10
    # }
    # addSampleWeight(samples, 'sm_WpToLNu_ZTo2J_'+operator, 'WpToLNu_ZTo2J_aQGC_Aug2024', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smReweight)
...
# target_operators = ['cT0', 'cS0'] #, 'cT2']
# # ################################################                                                                                                                     
# # # ---------->        to make datacard you need to skip VBS samples and other operators!!                                                                             
# operators_to_exclude = [op for op in theOperators if op not in target_operators]
