...
with open('/afs/cern.ch/work/i/izoi/VBSanalysis/CMSSW_11_1_4/src/PlotsConfigurations/Configurations/VBSjjlnu/EFTcoefficients/EFT_dim8_dictionary_oldbasis.py') as f:
    code = compile(f.read(), 'EFT_dim8_dictionary_oldbasis.py', 'exec')
    exec(code)
...
for operator, expressions in operators.items():
    ...
    addSampleWeight(samples, 'quad_'+operator, 'WpToLNu_WmTo2J_aQGC', quadReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WpTo2J_WmToLNu_aQGC', quadReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WpToLNu_WpTo2J_aQGC', quadReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WmToLNu_WmTo2J_aQGC', quadReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WmToLNu_ZTo2J_aQGC', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ quadReweight)
    addSampleWeight(samples, 'quad_'+operator, 'WpToLNu_ZTo2J_aQGC', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ quadReweight)
    ...
    #     'FilesPerJob': 10
    # }
    # addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WpToLNu_WmTo2J_aQGC', smLinQuadReweight)
    # addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WpTo2J_WmToLNu_aQGC', smLinQuadReweight)
    # addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WpToLNu_WpTo2J_aQGC', smLinQuadReweight)
    # addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WmToLNu_WmTo2J_aQGC', smLinQuadReweight)
    # addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WmToLNu_ZTo2J_aQGC', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smLinQuadReweight)
    # addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WpToLNu_ZTo2J_aQGC', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smLinQuadReweight)
    ...
    addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WpToLNu_WmTo2J_aQGC', LinReweight + '+' + quadReweight)
    addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WpTo2J_WmToLNu_aQGC', LinReweight + '+' + quadReweight)
    addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WpToLNu_WpTo2J_aQGC', LinReweight + '+' + quadReweight)
    addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WmToLNu_WmTo2J_aQGC', LinReweight + '+' + quadReweight)
    addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WmToLNu_ZTo2J_aQGC', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ '(' + LinReweight + '+' + quadReweight+ ')')
    addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WpToLNu_ZTo2J_aQGC', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ '(' + LinReweight + '+' + quadReweight+ ')')
    addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WmToLNu_ZTo2J_dipoleRecoil', '(Sum$(abs(GenPart_pdgId)==6)==0)')
    addSampleWeight(samples, 'sm_lin_quad_'+operator, 'WpToLNu_ZTo2J_dipoleRecoil', '(Sum$(abs(GenPart_pdgId)==6)==0)')
    ...
    #     'FilesPerJob': 10
    # }
    # addSampleWeight(samples, 'sm_'+operator, 'WpToLNu_WmTo2J_aQGC', smReweight)
    # addSampleWeight(samples, 'sm_'+operator, 'WpTo2J_WmToLNu_aQGC', smReweight)
    # addSampleWeight(samples, 'sm_'+operator, 'WpToLNu_WpTo2J_aQGC', smReweight)
    # addSampleWeight(samples, 'sm_'+operator, 'WmToLNu_WmTo2J_aQGC', smReweight)
    # addSampleWeight(samples, 'sm_'+operator, 'WmToLNu_ZTo2J_aQGC', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smReweight)
    # addSampleWeight(samples, 'sm_'+operator, 'WpToLNu_ZTo2J_aQGC', '(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smReweight)
...
operators_to_exclude = ["cT2", "cT1", "cT3", "cT4", "cT5", "cT6", "cT7", "cT8", "cT9", "c00", "cS1", "cM0", "cM1", "cM2", "cM3", "cM4", "cM5", "cM6", "cM7", "cM8", "cM9"]
full_operators_name_to_exclude = []
for op in operators_to_exclude:
   full_operators_name_to_exclude.append("sm_"+op)
...
################################################
# ---------->        to produce all operators
allOperators = ["cT0", "cT2", "cT1", "cT5", "cT6", "cT7", "cT8", "cT9", "cS0", "cS1", "cM0", "cM1", "cM2", "cM3", "cM4", "cM5", "cM6", "cM7", "cM8", "cM9"]
full_operators_name = []
...
################################################
# ---------->        to produce or merge one or multiple operators
theOperators = ["cS0"]
operators_name = []
for op in theOperators:   
    operators_name.append("sm_"+op)
    operators_name.append("quad_"+op)
    operators_name.append("sm_lin_quad_"+op)
operators_name.append("sm")
# samples = {   key:v for key,v in samples.items() if key in operators_name}