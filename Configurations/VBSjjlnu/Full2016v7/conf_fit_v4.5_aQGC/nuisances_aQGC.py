...
nuisances['electronpt']  = {
                ...
                'mapDown': 'ElepTdo',
                'cuts': phase_spaces_tot_ele,  
                'samples': dict((skey, ['1.','1.']) for skey in mc if skey not in ['Vg', 'VgS','ggWW'] + wjets_res_bins + VBS_aQGC_all_samples),
...
nuisances['pdf_weight'] = { # --> Now save also the normalization one for the signal
    ...
    'kind'  : 'weight_envelope',
    'type'  : 'shape',
    'samples' :  { s: [' Alt$(LHEPdfWeight['+str(i)+'], 1.)' for i in range(0,103)] for s in VBS_aQGC_all_samples},
    'AsLnN':  '1'
}
#############################
nuisances['PU']  = {
