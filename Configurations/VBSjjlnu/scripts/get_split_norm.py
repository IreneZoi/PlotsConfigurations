...
others=['DY','top','VVV','VBF-V_dipole','ggWW','Vg','VgS','DATA']
...
for cat in ["res","boost"]:
    for fl in ["ele","mu"]:
        ...
        cuts.append("{}_topcr_{}".format(cat, fl))
        cuts.append("{}_wjetcr_{}".format(cat, fl))
...
for cut in cuts:
    for s in VBS_samples + VV_samples + others:    
